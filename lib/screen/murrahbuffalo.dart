              ...
              child: Row(
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    onTap: (){
                      Navigator.push(context,MaterialPageRoute(builder:(context)=> const Feeding_management()));
                    },
                  ),
                ],
              ),
                ...
                children: [
                  ...
                  InkWell(
                    child: Container(
                      ...
                      child: Text('Health Care Management ',
                      style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.w700,
                        color: Colors.white
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    child: Text('Management Practices',
                    style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.w700,
                      color: Colors.white
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          filterQuality: FilterQuality.high,
                          opacity: 0.8,
                          image: AssetImage('assets/images/thermal_stress.jpeg'),
                          fit: BoxFit.cover),
                    ),
                    child: Text('Thermal Stress Management ',
                    style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.w700,
                      color: Colors.white
